...
# 결론 : '가사 및 육아 도우미'의 월급이 평균 80만원 으로 가장 적고, 그 뒤로는 '임업관련 종사자'라는 것을 알 수 있다. 상-하위 분석 결과를 비교하면 가장많은 월급을 받는 '금속 재료 공학 기술자 및 시험원'이 '가사 및 육아 도우미'의 열 배가 넘는 월급을 받는다는 것을 알 수 있다. 